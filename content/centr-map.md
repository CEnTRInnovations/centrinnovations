---
title: "CEnTR*MAP — Mapping Community Ecosystems"
description: "Reveal, model, and strengthen community-engaged research through a participatory platform grounded in Community Cultural Wealth, ecological systems thinking, and relationship-centered asset mapping."
layout: "map"
type: "map"
...
hero_lead_2: "CEnTR*MAP starts somewhere different. Not with what communities lack, but with what they have. It maps, reveals, and models the relationships between community assets — surfacing how engagement ecosystems actually function and evolve over time."
...
framework_title: "Three frameworks. One coherent orientation toward community ecosystems."
framework_sidebar_1: "CEnTR*MAP is not a neutral container for data. Its structure embodies a set of commitments about what matters, what counts as knowledge, and whose assets — formal and informal, lived and historical — are worth revealing. Those commitments are grounded in three interlocking theoretical traditions."
framework_sidebar_2: "Understanding the frameworks is understanding why the platform works the way it does. They aren't background — they are the architecture. Together, they shift the focus from static inventories of entities to living, networked ecosystems of relationships."
...
framework_f2_body: "Yosso's Community Cultural Wealth (2005) expands the concept of capital beyond economic resources to encompass the full range of knowledge, skills, and networks that communities possess and draw upon — aspirational, linguistic, familial, social, navigational, and resistance capital. CEnTR*MAP structures its asset taxonomy around this framework, ensuring that what gets mapped includes informal and lived assets — community knowledge, trust, informal leadership, and historical heritage — not just the formal resources institutional systems typically recognize."
...
platform_sidebar_1: "CEnTR*MAP can work from existing textual artifacts — interview transcripts, project reports, research memos — rather than requiring new data entry. Narrative is not merely an interface feature. It is a living data source that communities and researchers can revisit, reinterpret, and build upon as the ecosystem evolves."
platform_sidebar_2: "Predefined forms are available for structured input. But the platform's distinctive capability is processing narrative-rich documentation and revealing what it contains: relationships between assets, capital flows across system levels, and outcomes understood in community terms — not institutional ones."
...
platform_note: "AI-assisted processes scaffold interpretation — they do not replace it. The system surfaces relationships, connections, and gaps while communities and researchers maintain control over how their ecosystem is represented and understood."

# ─────────────────────────────────────────
# USE CASES
# ─────────────────────────────────────────
uses_eyebrow: "What Becomes Possible"
uses_title: "From fragmented representation to a living, relationship-centered understanding of community ecosystems."
...
field_title: "A living vocabulary for community ecosystems — across institutions, not just within them."
field_sidebar_1: "Ecosystem mapping is most powerful when it evolves over time — when communities can see how their relationships and assets develop, track how engagement changes, and use that living picture to guide coordination, reduce duplication, and strengthen alignment."
field_sidebar_2: "CEnTR*MAP's capital taxonomy, organized around a shared framework, is itself the infrastructure: not a database to report into, but a vocabulary for sensemaking that travels across institutional contexts while staying rooted in community knowledge and community control."
field_quote: "The shared vocabulary is the infrastructure. Not a reporting system — a living framework for understanding that reveals how community ecosystems function and evolve, across institutions and over time."
